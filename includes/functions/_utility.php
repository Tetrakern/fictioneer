...
function fcntr( $key, $escape = false ) {
  ...
  $strings = array(
    ...
    'logged_in_as' => _x( '<span>Logged in as <strong><a href="%1$s">%2$s</a></strong>. <a class="logout-link" href="%3$s" onclick="fcn_cleanupLocalStorage()">Log out?</a></span>', 'Comment form logged-in note.', 'fictioneer' ),
