...
define( 'FICTIONEER_OPTIONS', array(
  'booleans' => array(
    ...
    'enable_patreon_data_inheritance' => array(
      'name' => 'enable_patreon_data_inheritance',
      'group' => 'fictioneer-settings-general-group',
      'sanitize_callback' => 'fictioneer_sanitize_checkbox'
    ),
  ),
...
function fictioneer_get_option_label( $option ) {
  ...
  if ( $labels === null ) {
    $labels = array(
      ...
      'enable_patreon_data_inheritance' => __( 'Enable Patreon gate inheritance', 'fictioneer' ),
    );
  }
