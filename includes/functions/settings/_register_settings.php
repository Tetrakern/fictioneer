...
define( 'FICTIONEER_OPTIONS', array(
  'booleans' => array(
    ...
    'fictioneer_stagger_update_queries' => array(
      'name' => 'fictioneer_stagger_update_queries',
      'group' => 'fictioneer-settings-general-group',
      'sanitize_callback' => 'fictioneer_sanitize_checkbox'
    ),
  ),
...
function fictioneer_get_option_label( $option ) {
  ...
  if ( $labels === null ) {
    $labels = array(
      ...
      'fictioneer_stagger_update_queries' => __( 'Stagger database update queries', 'fictioneer' ),
    );
  }
