...
chapterId:Number};ready=!1;paused=!1;initialize(){document.addEventListener("fcnUserDataReady",(()=>{this.#e(),this.ready=!0,this.#t()}))}connect(){this.ready&&(this.#e(),this.#t())}disconnect(){this.#n()}isFollowed(){return this.#s()&&!!this.#o()?.follows?.data?.[this.storyIdValue]}isRemembered(){return this.#s()&&!!this.#o()?.reminders?.data?.[this.storyIdValue]}isRead(){if(!this.#s())return!1;const e=this.#o()?.checkmarks?.data?.[this.storyIdValue];return!!e&&(e.includes(this.chapterIdValue)||e.includes(this.storyIdValue))}toggleFollow(){this.#s()?(fcn_toggleFollow(this.storyIdValue),this.#i()):_$$$("modal-login-toggle")?.click()}toggleReminder(){this.#s()?(fcn_toggleReminder(this.storyIdValue),this.#a()):_$$$("modal-login-toggle")?.click()}toggleCheckmarks(e="toggle",t){this.#s()?(fcn_toggleCheckmark(this.storyIdValue,t,this.chapterIdValue,null,e),this.#c()):_$$$("modal-login-toggle")?.click()}setCheckmarks(e){this.toggleCheckmarks("set",e.params?.type??"story")}unsetCheckmarks(e){this.toggleCheckmarks("unset",e.params?.type??"story")}#r=null;#l=0;#s(){const e=Date.now();return null!==this.#r&&e-this.#l<20||(this.#r=fcn_isUserLoggedIn(),this.#l=e,this.#r||(this.#n(),this.ready=!1,this.paused=!0)),this.#r}#o(){return this.userData=fcn_getUserData(),this.userData}#d(){return this.#s()&&JSON.stringify(this.userData)!==JSON.stringify(this.#o())}#f(){this.refreshInterval||(this.refreshInterval=setInterval((()=>{!this.paused&&this.#d()&&this.#e()}),3e4+1e4*Math.random()))}#t(){this.#f(),this.visibilityStateCheck=()=>{this.#s()&&("visible"===document.visibilityState?(this.paused=!1,this.#e(),this.#f()):(this.paused=!0,clearInterval(this.refreshInterval),this.refreshInterval=null))},document.addEventListener("visibilitychange",this.visibilityStateCheck)}#n(){clearInterval(this.refreshInterval),document.removeEventListener("visibilitychange",this.visibilityStateCheck)}#e(){this.#i(),this.#a(),this.#c()}#i(){this.element.classList.toggle("has-follow",this.isFollowed())}#a(){this.element.classList.toggle("has-reminder",this.isRemembered())}#c(){this.element.classList.toggle("has-checkmark",this.isRead())}});