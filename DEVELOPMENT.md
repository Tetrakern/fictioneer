...
| `admin_menu` | `fictioneer_add_admin_menu`, `fictioneer_reduce_moderator_admin_panel`, `fictioneer_remove_dashboard_menu`, `fictioneer_remove_menu_pages`, `fictioneer_remove_comments_menu_page`
