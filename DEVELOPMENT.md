...
| `rest_api_init` | `fictioneer_register_endpoint_get_story_comments` (10), `fictioneer_rest_setup` (10), `wp_oembed_register_route` (10)
...
| `rewrite_rules_array` | `fictioneer_remove_embed_rewrites` (10)
