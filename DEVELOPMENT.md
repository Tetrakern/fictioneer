...
| `pre_get_posts` | `fictioneer_extend_search_query`, `fictioneer_remove_unlisted_from_search`, `fictioneer_read_others_files`
...
| `map_meta_cap` | `fictioneer_edit_others_files`, `fictioneer_delete_others_files`
