...
?>
    ...
    <?php
      ...
      if ( get_option( 'fictioneer_enable_lightbox' ) ) {
        echo
          '<div id="fictioneer-lightbox" class="lightbox"><button type="button" class="lightbox__close" aria-label="',
          esc_attr__( 'Close lightbox', 'fictioneer' ),
          '">',
          fictioneer_get_icon( 'fa-xmark' ),
...
if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
  ...
  echo
    '<!-- Render Time: ',
    number_format( microtime( true ) - $fictioneer_render_start_time, 4 ),
    ' seconds. -->';
}
