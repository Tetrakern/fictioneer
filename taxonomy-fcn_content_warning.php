...
$output['heading'] = '<h1 class="archive__heading">' . sprintf(
  _n(
    '<span class="archive__heading-number">%1$s</span> Result with the <em>"%2$s"</em> warning %3$s',
    '<span class="archive__heading-number">%1$s</span> Results with the <em>"%2$s"</em> warning %3$s',
    $term->count,
    'fictioneer'
  ),
  $term->count,
