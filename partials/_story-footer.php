...
// Status
$meta_output['status'] = '<span class="story__meta-item story__status _' . strtolower( $story['status'] ) . '"><i class="' . $story['icon'] . '"></i> ' . fictioneer_get_story_status_label( $story_id, $story['status'] ) . '</span>';
